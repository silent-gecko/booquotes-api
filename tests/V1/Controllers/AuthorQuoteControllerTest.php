...
class AuthorQuoteControllerTest extends \TestCase
{
    ...
    public function test_show_returns_valid_response_with_valid_id()
    {
        ...
        $this->actingAs($user)
            ->json('get', route('v1.author.quote.show', ['uuid' => $author->id]));
    ...
    public function test_show_returns_valid_response_with_invalid_id()
    {
        ...
        $this->actingAs($user)
            ->json('get', route('v1.author.quote.show', ['uuid' => '0']));
    ...
    public function test_show_returns_not_found_error()
    {
        ...
        $this->actingAs($user)->json('get', route('v1.author.quote.show', ['uuid' => $nonExistingUuid]));
